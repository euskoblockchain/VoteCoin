...
public:
    CMainParams() {
        ...
        bip44CoinType = 1331; // As registered in https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000000e23bf7a5d76");
